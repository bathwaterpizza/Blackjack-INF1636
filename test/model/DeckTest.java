...
public class DeckTest {
	...
	public void testDeckComplete() {
		...
		Assert.assertEquals("The deck is complete", 416, deck.getDeckSize());
	}
	...
	public void testShouldntReshuffle() {
		...
		Assert.assertFalse("The deck didn't reshuffle",isDiferent);
	...
	public void testShouldReshuffle() {
		...
		Assert.assertTrue("The deck did reshuffle",isDiferent);
	...
	public void testDeckIsEmpty() {
		...
		try {
			...
			Assert.assertEquals("Deck is empty", e.getMessage());
		}
	}
	...
	public void testDecksDifferentSize(){
		...
		Assert.assertTrue("The decks have different sizes", !(deck1.getDeckSize() == deck2.getDeckSize()));
